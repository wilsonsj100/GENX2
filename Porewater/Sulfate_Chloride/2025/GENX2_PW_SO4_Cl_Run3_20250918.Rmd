...
author: "2025 Samples Run 3"
date: "Date QAQC'd: `r Sys.Date()`"
output: 
  pdf_document:
    toc: true
...
###### Run information - PLEASE CHANGE
  Date_Run = "2025-09-18"  #Date that instrument was run
  Year_run = "2025" #Year that instrument was run
  Run_by = "Zoe Read"  #Instrument user 
  Script_run_by = "Zoe Read" #Code user 
  run_notes = "Chk std 1 SO4 is slightly lower than the expected concentration. 
  One dup (185_GX2_50143) had high CV. 
  166_GX2_50116 was above the SO4 detection limit (24.5 ppm vs the 20 ppm detection limit)
  " #any notes from the run

###### File Names - PLEASE CHANGE 
#file path and name for raw summary data file 
  raw_file_name_cl = "Raw Data/GenX2_Mesocosms2025_PW_Run3_20250918_Cl.txt"
  raw_file_name_so4 = "Raw Data/GenX2_Mesocosms2025_PW_Run3_20250918_SO4.txt"

#file path and name of processed data file 
  processed_file_name = "Processed Data/GenX2_Mesocosms2025_PW_Processed_Cl_SO4_Run3_20250918.csv" 
